...
\title{
  \LARGE Understanding and Implementing Level Set Methods\\
  \large Department of computer science at Aarhus University
}
\author{
...
\chapter{Signed distance field}
\label{chap:sdf}
\input{text/sdf}

\section{Initialization}
\label{sec:initialization}
\input{text/build_sdf}


\section{Constructive geometry operations}
\label{sec:csg}
\input{text/csg}
...
\input{text/reinitialization}


\chapter{Evolving the interface}
\label{chap:motion}
\section{Externally generated velocity field}
%\input{text/theory_eulerian_lagrangian}
%\subsection{Sean}
\input{text/externalvelocity}\label{sec:extVel}

\section{Internally generated velocity field}
\label{sec:intVel}
\input{text/motion}

\chapter{Narrow-band}
\label{sec:narrowband}
\input{text/narrowband}
